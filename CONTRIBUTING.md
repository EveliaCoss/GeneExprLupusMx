...
This outlines how to propose a change to GeneExprLupusMx. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("EveliaCoss/GeneExprLupusMx", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://eveliacoss.github.io/GeneExprLupusMx/CODE_OF_CONDUCT.md).
